...
local function setup()
	...
	-- Telescope support
	hl("TelescopeNormal", { fg = colors.editorForeground, bg = colors.dropdownBackground })
	hl("TelescopeBorder", { fg = "#333e4f" })
	hl("TelescopePromptBorder", { fg = "#333e4f" })
	hl("TelescopeResultsBorder", { fg = "#333e4f" })
	hl("TelescopePreviewBorder", { fg = "#333e4f" })
	hl("TelescopePromptNormal", { fg = colors.editorForeground, bg = colors.inputBackground })
	hl("TelescopePromptPrefix", { fg = colors.buttonBackground })
	hl("TelescopeSelection", { fg = colors.editorForeground, bg = colors.selectionBackground, bold = true })
	hl("TelescopeSelectionCaret", { fg = colors.buttonBackground })
	hl("TelescopeMatching", { fg = colors._yellow, bold = true })
	hl("TelescopeTitle", { fg = colors.editorBackground, bg = colors.buttonBackground, bold = true })

	-- Nvim-tree support
	hl("NvimTreeNormal", { fg = colors.editorForeground, bg = colors.sidebarBackground })
	hl("NvimTreeNormalFloat", { fg = colors.editorForeground, bg = colors.sidebarBackground })
	hl("NvimTreeNormalNC", { fg = colors.editorForeground, bg = colors.sidebarBackground })
	hl("NvimTreeWinSeparator", { fg = "#333e4f" })
	hl("NvimTreeFolderName", { fg = colors.constant, bold = true })
	hl("NvimTreeFolderIcon", { fg = colors.constant })
	hl("NvimTreeOpenedFolderName", { fg = colors.constant, bold = true })
	hl("NvimTreeOpenedFolderIcon", { fg = colors.constant })
	hl("NvimTreeEmptyFolderName", { fg = colors.comment })
	hl("NvimTreeEmptyFolderIcon", { fg = colors.comment })
	hl("NvimTreeGitDirty", { fg = colors.diffModified })
	hl("NvimTreeGitStaged", { fg = colors.diffAdded })
	hl("NvimTreeGitMerge", { fg = colors.diffConflict })
	hl("NvimTreeGitRenamed", { fg = colors.diffModified })
	hl("NvimTreeGitNew", { fg = colors.diffAdded })
	hl("NvimTreeGitDeleted", { fg = colors.diffRemoved })
	hl("NvimTreeSpecialFile", { fg = colors.string })
	hl("NvimTreeIndentMarker", { fg = "#333e4f" })
	hl("NvimTreeImageFile", { fg = colors.string })
	hl("NvimTreeSymlink", { fg = colors.link, underline = true })
	hl("NvimTreeRootFolder", { fg = colors.buttonBackground, bold = true })
	hl("NvimTreeExecFile", { fg = colors.string })
	hl("NvimTreeOpenedFile", { fg = colors.editorForeground })
	hl("NvimTreeModifiedFile", { fg = colors.diffModified })
	hl("NvimTreeBookmark", { fg = colors.variable })

	-- Which-key support
	hl("WhichKey", { fg = colors.editorForeground })
	hl("WhichKeyGroup", { fg = colors.constant })
	hl("WhichKeySeparator", { fg = colors.comment })
	hl("WhichKeyDesc", { fg = colors.comment })
	hl("WhichKeyFloat", { fg = colors.editorForeground, bg = colors.dropdownBackground })
	hl("WhichKeyBorder", { fg = "#333e4f" })

	-- Indent-blankline support
	hl("IndentBlanklineChar", { fg = "#333e4f" })
	hl("IndentBlanklineContextChar", { fg = colors.buttonBackground })
	hl("IndentBlanklineSpaceChar", { fg = "#333e4f" })
	hl("IndentBlanklineContextStart", { sp = colors.buttonBackground, underline = true })

	-- Bufferline support
	hl("BufferLineFill", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineBackground", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineBufferVisible", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineBufferSelected", { fg = colors.editorForeground, bg = colors.editorBackground, bold = true })
	hl("BufferLineIndicatorSelected", { fg = colors.buttonBackground })
	hl("BufferLineIndicatorVisible", { fg = colors.buttonBackground })
	hl("BufferLineCloseButton", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineCloseButtonVisible", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineCloseButtonSelected", { fg = colors.editorForeground, bg = colors.editorBackground })
	hl("BufferLineModified", { fg = colors.diffModified, bg = colors.statuslineBackground })
	hl("BufferLineModifiedVisible", { fg = colors.diffModified, bg = colors.statuslineBackground })
	hl("BufferLineModifiedSelected", { fg = colors.diffModified, bg = colors.editorBackground })
	hl("BufferLineSeparator", { fg = colors.statuslineBackground, bg = colors.statuslineBackground })
	hl("BufferLineSeparatorVisible", { fg = colors.statuslineBackground, bg = colors.statuslineBackground })
	hl("BufferLineSeparatorSelected", { fg = colors.editorBackground, bg = colors.editorBackground })
	hl("BufferLineTab", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineTabClose", { fg = colors.statuslineForeground, bg = colors.statuslineBackground })
	hl("BufferLineTabSelected", { fg = colors.editorForeground, bg = colors.editorBackground, bold = true })
	hl("BufferLineTabCloseSelected", { fg = colors.editorForeground, bg = colors.editorBackground })
